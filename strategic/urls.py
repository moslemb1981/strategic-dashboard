...
urlpatterns = [
    ...
    path("audit-findings/", views.audit_findings, name="audit_findings"),
    path("audit-findings/delete/<int:pk>/", views.audit_finding_delete, name="audit_finding_delete"),
    path("audit-findings/export/", views.audit_findings_export, name="audit_findings_export"),
    path("audit-findings/import/", views.audit_findings_import, name="audit_findings_import"),
    ...
    path("operational-kpis/import/apply/", views.operational_kpi_import_apply, name="operational_kpi_import_apply"),
    path("operational-kpis/import/cancel/", views.operational_kpi_import_cancel, name="operational_kpi_import_cancel"),
    path("operational-kpis/<int:pk>/trend/", views.operational_kpi_trend_data, name="operational_kpi_trend_data"),
    path("operational-kpis/<int:pk>/trend/multi/", views.operational_kpi_trend_multi, name="operational_kpi_trend_multi"),
    path("operational-kpis/<int:pk>/trend/delete/", views.operational_kpi_trend_delete, name="operational_kpi_trend_delete"),
